...
public class SubFamiliesConservation {
	...
	for (int i = 0; i < subGroups.size(); i++) {
	    ...
	    double[] conservation = ConservationClient.getSMERFS(alignment,
		    width, scoreType, gapTreshold, normalize);
	...
	for (int i = 0; i < subGroups.size(); i++) {
		...
		double[] score = ConservationClient.getSMERFS(alignment, width,
			scoreType, gapTreshold, normalize);
