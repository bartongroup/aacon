...
public class MethodWrapper implements Callable<double[]> {
	...
	public MethodWrapper(String method, ConservationScores2 scores, boolean normalize) {
	...
	public MethodWrapper(ConservationScores2 scores, boolean normalize, int SMERFSWidth,
			double SMERFSGapTreshold) {
	...
	public double[] call() throws Exception {
		...
		double[] result = ParallelConservationClient
				.getMethod(method.toString(), scores, normalize);
		return result;
	}
}
