...
public class ColumnScores {
   ...
   // }
    ...
    static double joresScore(AminoAcidMatrix matrix, int colNr) {
 	...
 	result = ((double) totalPairs / (double) mostFreqNr) * ((matrix.getInverseMatrix()[colNr].length) * (matrix.getInverseMatrix()[colNr].length -1 ) / 2); 
	...
	if (colNr > matrix.numberOfColumns() - 1) {
		...
		Map<Character, Integer> acidsMapNoGaps = new HashMap<Character,Integer>(matrix.getTotalAcidsFreqByCol().get(colNr));
	...
	if (colNr > matrix.numberOfColumns() - 1) {
 		...
 		while(itr.hasNext()) {
 			...
 			if(setMap.get(itr.next()).containsAll(matrix.getTotalAcidsFreqByCol().get(colNr).keySet())) {
	...
	if (colNr > matrix.numberOfColumns() - 1) {
 		...
 		for( int a = 0; a < matrix.getInverseMatrix()[colNr].length; a++) {
 			...
 			if(matrix.getInverseMatrix()[colNr][a] != '-') {
 			
 				for(int b = a + 1; b < matrix.getInverseMatrix()[colNr].length; b++) {
 					
 					if(matrix.getInverseMatrix()[colNr][b] != '-') {
 						
 						double pairScore =  ConservationMatrices.BlosumPair(matrix.getInverseMatrix()[colNr][a], matrix.getInverseMatrix()[colNr][b]);
 						
 						double aSelf =  ConservationMatrices.BlosumPair(matrix.getInverseMatrix()[colNr][a], matrix.getInverseMatrix()[colNr][a]);
 						
 						assert aSelf > 0;
 						
 						double bSelf = ConservationMatrices.BlosumPair(matrix.getInverseMatrix()[colNr][b], matrix.getInverseMatrix()[colNr][b]);
	...
	if (colNr > matrix.numberOfColumns() - 1) {
 		...
 		for (int a = 0; a < matrix.getInverseMatrix()[colNr].length; a++) {
 			...
 			for (int b = 0; b < alp.length; b++) {
 				...
 				points[a][b] = ConservationMatrices.BlosumPair(matrix.getInverseMatrix()[colNr][a], alp[b]);
 		...
 		meanPoint = ConservationAccessory.multPointByScalar(sum, 1.0/(double) matrix.getInverseMatrix()[colNr].length);
 		
 		for (int c = 0; c < matrix.getInverseMatrix()[colNr].length; c++) {
 		...
 		if (matrix.getTotalAcidsFreqByCol().get(colNr).keySet().contains('-')) {
 			...
 			nonGapsFraction = (double) (matrix.getInverseMatrix()[colNr].length - matrix.getTotalAcidsFreqByCol().get(colNr).get('-')) / (double) matrix.getInverseMatrix()[colNr].length;
	...
	if (colNr > matrix.numberOfColumns() - 1) {
		...
		while (itr1.hasNext()) {
			...
			while (itr2.hasNext()) {
				...
				result = result + ((((double)matrix.getTotalAcidsFreqByCol().get(colNr).get(key1)/ (double) matrix.getInverseMatrix()[colNr].length * (double) matrix.getTotalAcidsFreqByCol().get(colNr).get(key2)/ (double) matrix.getInverseMatrix()[colNr].length)) * blosum);
			}
		}
	...
	if (colNr > matrix.numberOfColumns() - 1) {
		...
		for (int a = 0; a < matrix.getInverseMatrix()[colNr].length; a++) {
			...
			for (int b = a + 1; b < matrix.getInverseMatrix()[colNr].length; b++) {
				...
				double disIJ = ConservationMatrices.dissimilarity(matrix.getInverseMatrix()[colNr][a], matrix.getInverseMatrix()[colNr][b]);
				
				double disJI = ConservationMatrices.dissimilarity(matrix.getInverseMatrix()[colNr][b], matrix.getInverseMatrix()[colNr][a]);
	...
	if (colNr > matrix.numberOfColumns() - 1) {
		...
		for (int a = 0; a < matrix.getInverseMatrix()[colNr].length; a++) {
			...
			for (int b = a + 1; b < matrix.getInverseMatrix()[colNr].length; b++) {
				...
				sum = sum + (1 - matrix.getPercentIdentity()[a][b]) * ConservationMatrices.pam250Pair(matrix.getInverseMatrix()[colNr][a], matrix.getInverseMatrix()[colNr][b]);
			}
	...
	if (colNr > matrix.numberOfColumns() - 1) {
		...
		for (int a = 0; a < matrix.getInverseMatrix()[colNr].length; a++) {
			...
			for (int b = a + 1; b < matrix.getInverseMatrix()[colNr].length; b++) {
				...
				sum = sum + matrix.vingronArgosWeights()[a] * matrix.vingronArgosWeights()[b] * ConservationMatrices.pet91Pair(matrix.getInverseMatrix()[colNr][a], matrix.getInverseMatrix()[colNr][b]);
			}
