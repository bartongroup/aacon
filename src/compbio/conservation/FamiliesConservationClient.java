			...
			if (sequences != null) {
				...
				long time1 = System.currentTimeMillis();
					...
					if (Method.getMethod(method) == Method.SMERFS) {
						...
						info1 = sub.subgrupsConservation3(SMERFSWidth, SMERFSGapTreshold, score, normalize);
						
						info2 = sub.subFamilyPairsConservation3(SMERFSWidth, score, SMERFSGapTreshold, normalize);
						...
						info2 = sub.subFamilyPairsConservation2(Method.getMethod(method), normalize);
					...
					print.println(Method.getMethod(method).toString() + " done " + time + "ms.");
					...
					try {
						...
						print2 = new PrintWriter( new BufferedWriter (new FileWriter(outFilePath)));
					}
