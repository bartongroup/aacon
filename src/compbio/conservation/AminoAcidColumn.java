    	...
    	for (int i = 0; i < aaOcc.length; i++) {
    		...
    		if (aaOcc[i].getId() == '-' || aaOcc[i].getOccurance() == 0)
    			break;
    			      ...
    			      int nr1 = (aaOcc[i].getOccurance() * aaOcc[i].getOccurance()) - aaOcc[i].getOccurance() / 2;
    		     ...
    		     for ( int j = 0; j < aaOcc.length; i++) {
    			         ...
    			         if (aaOcc[i].getId() == aaOcc[j].getId() || aaOcc[j].getId() == '-')
    			        	 break;
    			         
    			         else { diffPairs++;
    			    		
       			                    int nr2 = aaOcc[i].getOccurance() * aaOcc[j].getOccurance();
...
// 	special case # 3
	...
	if(this.onlyOneResType() == true) {
		...
		pairTypes = (this.howManyResidueTypes() * (this.howManyResidueTypes() - 1)) / 2 + this.howManyResidueTypes();
