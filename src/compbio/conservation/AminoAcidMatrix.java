 ...
 * in the fasta file are of the same length.
 * 
 * This class creates a matrix which has rows of equal length. If constructor is
 * fed an alignment with sequences of not equal length an exception is thrown.
 * 
 * @author agolicz
 * 
 */
